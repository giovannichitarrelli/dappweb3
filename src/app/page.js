    ...
    return (
        <>
            ...
            <div className="container px-4 py-5">
                <div className="row flex-lg-row-wrap align-items-center g-5 py-5">
                    <div className="col-lg-6">
                        ...
                        <div className="d-flex justify-content-start">
                            <button type="button" className="btn btn-primary btn-lg px-4" onClick={btnLoginClick}>
                                <img src="/metamask.svg" width={44} className="mr-2" />
                                Conectar MetaMask
                            </button>
                        </div>
                    ...
                    <div className="col-lg-6">
                        <img src="https://i0.wp.com/apublica.org/wp-content/uploads/2024/07/Capa_No-combate-Kamala-x-Trump-contraste-na-agenda-climatica-fica-mais-dramatico.webp?fit=774%2C516&ssl=1" className="d-block mx-lg-auto img-fluid rounded" width="700" height="500" />
                    </div>

    ...
    return (
        <>
            ...
            <div className="container px-4 py-5 ">
                ...
                <div className="row flex-lg-row-wrap align-items-center g-1 py-5">
                    {/* <div className="col bg-primary"></div> */}
                    {
                        dispute.winner == 0 || dispute.winner == 1
                            ? <div className="col">
                                <h3 className="my-2 d-block mx-auto text-center" >
                                    {dispute.candidate1}
                                </h3>
                                <img src={dispute.image1} className="d-block mx-auto  rounded-circle" width={250} />
                                {
                                    dispute.winner == 1
                    ...
                    }
                    {
                        dispute.winner == 0 || dispute.winner == 2
                            ? <div className="col">
                                ...
                                <img src={dispute.image2} className="d-block mx-auto img-fluid rounded-circle" width={250} />
                                {
                                    dispute.winner == 2
                                        ? <button className="btn btn-primary p-3 my-2 d-block mx-auto" style={{ width: 250 }} onClick={btnClaimClick}>Pegar meu prêmio</button>
